...
public class MenuTracker{
	...
	*/
	private class EditItem extends BaseAction{
		...
		* */
		public void execute(Input input, Tracker tracker){
			int id = Integer.parseInt(input.ask ("Please, enter the task's id to edit: "));
			String name = input.ask ("Please, enter the task's name: ");
			String desc = input.ask ("Please, enter the task desc: ");
	...
	*/
	private class DeleteItem extends BaseAction{
		...
		* */
		public void execute(Input input, Tracker tracker){
			int id = Integer.parseInt(input.ask ("Please, enter the task's id to delete: "));
	...
	*/
	private class AddComment extends BaseAction{
		...
		* */
		public void execute(Input input, Tracker tracker){
			int id = Integer.parseInt(input.ask ("Please, enter the task's id to add comment: "));
