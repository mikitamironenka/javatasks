...
public class  UserStore {
    ...
    private static final String CREATE_USERS_TABLE_QUERY = "CREATE TABLE IF NOT EXISTS userswithpass(id serial PRIMARY KEY," +
            "name VARCHAR(20), login VARCHAR(20), password VARCHAR(20), email VARCHAR(20), role_id INTEGER, createdate TIMESTAMP);";

    private static final String CREATE_ROLES_TABLE_QUERY = "CREATE TABLE IF NOT EXISTS roles(id serial primary key, role_id INTEGER, name VARCHAR(20));";
